...
private:
	...
	void after_grouping(std::vector<OperationsGroup> &groups, const int &lowestlimitgroup);
	...
	void try_to_move_group_below(std::vector<OperationsGroup> &groups, const int &indexgroup, const int &lowestlimitgroup);
